;!function (win, $, undefined) {
	var SVGMap = (function () {
		...
		SVGMap.prototype.options = {
			...
			mapWidth: 500,
			mapHeight: 400,
			stateColorList: ['86FF61', 'E8BE5D', '8AFF57', '6251E8', '3CFFC8'],
			...
			stateInitColor: 'ce0707',
			stateHoverColor: '3689f0',
			stateSelectedColor: '666666',
		...
		SVGMap.prototype.render = function () {
			...
			for (var state in mapConfig.shapes) {
				var thisStateData = stateData[state],
					initColor = '#' + (thisStateData && thisStateData.stateInitColor || opt.stateInitColor),
					hoverColor = '#' + (thisStateData && opt.stateColorList[thisStateData.stateHoverColor] || opt.stateHoverColor),
